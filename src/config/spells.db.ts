...
export const SPELLS_DB: Record<string, SpellDef> = {
  ...
  fire_bolt: {
    ...
    minLevel: 1, range: 2, areaType: 'line',
    description: 'Raio de fogo em linha reta até 2 tiles, pode acertar múltiplos inimigos.',
  },
  ice_bolt: {
    ...
    minLevel: 1, range: 2, areaType: 'line',
    description: 'Projétil de gelo em linha reta até 2 tiles, pode acertar múltiplos inimigos.',
  },
  great_fire: {
    id: 'great_fire', name: 'Great Fire', element: 'fire',
    damage: 20, manaCost: 14, cooldownMs: 1500, projectileSpeed: 2,
    animKey: 'spell_fire_fly', impactAnimKey: 'spell_fire_impact',
    minLevel: 1, range: 3, areaType: 'radial',
    description: 'Grande explosão de fogo em todas as direções até 3 tiles.',
  },
  ice_shard: {
