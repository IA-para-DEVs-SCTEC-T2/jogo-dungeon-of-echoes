...
export const SPELLS_DB: Record<string, SpellDef> = {
  ...
  ice_shard: {
    ...
    damage: 20, manaCost: 12, cooldownMs: 1100, projectileSpeed: 2.5,
  ...
  wind_cyclone: {
    ...
    damage: 18, manaCost: 10, cooldownMs: 950, projectileSpeed: 4,
    animKey: 'spell_wind_fly', impactAnimKey: 'spell_wind_impact',
    minLevel: 10,
  ...
  fire_explosion: {
    ...
    damage: 35, manaCost: 22, cooldownMs: 2000, projectileSpeed: 2,
    animKey: 'spell_fire_fly', impactAnimKey: 'spell_fire_impact',
    minLevel: 15,
  ...
  blizzard: {
    ...
    damage: 45, manaCost: 30, cooldownMs: 2500, projectileSpeed: 1.8,
    animKey: 'spell_ice_fly', impactAnimKey: 'spell_ice_impact',
    minLevel: 20,
