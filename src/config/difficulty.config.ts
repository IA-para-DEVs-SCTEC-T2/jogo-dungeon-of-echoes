...
export const FLOOR_DIFFICULTY_TABLE: Record<number, FloorDifficulty> = {
  ...
  2: { floor: 2, enemyHpMultiplier: 1.30, enemyAtkMultiplier: 1.20, enemyCount: 7,  lootQualityBonus: 0 },
  3: { floor: 3, enemyHpMultiplier: 1.70, enemyAtkMultiplier: 1.40, enemyCount: 8,  lootQualityBonus: 1 },
  4: { floor: 4, enemyHpMultiplier: 2.20, enemyAtkMultiplier: 1.65, enemyCount: 9,  lootQualityBonus: 1 },
  5: { floor: 5, enemyHpMultiplier: 2.80, enemyAtkMultiplier: 1.90, enemyCount: 10, lootQualityBonus: 2 },
};
...
export function getFloorDifficulty(floor: number): FloorDifficulty {
  ...
  return {
    floor,
    enemyHpMultiplier:  base.enemyHpMultiplier  + extra * 0.40,
    enemyAtkMultiplier: base.enemyAtkMultiplier  + extra * 0.20,
